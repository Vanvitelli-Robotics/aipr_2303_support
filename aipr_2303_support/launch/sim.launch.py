...
def generate_launch_description():
    ...
    ld.add_action(DeclareLaunchArgument('urdf_package_path',
                                        default_value='urdf/meca_500_r3.urdf.xacro',
                                        description='The path to the robot description relative to the package root'))
    ########################################

    #### Argument: .rviz config file location #####
    # Find the path of the package 'uclv_aipr_panda_sim'
    this_package = FindPackageShare('aipr_2303_support')
    default_rviz_config_path = PathJoinSubstitution([this_package, 'launch', 'sim.rviz'])
